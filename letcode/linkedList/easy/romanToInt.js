...
var romanToInt = function(s) {
    // create a map to map any roman number to an integer
    let romanToInt = {
        I: 1,
        V: 5,
        X: 10,
    ...
    let total = 0; // track our total

    for (let i = 0; i < s.length; i++) {
        let currentInt = romanToInt.charAt[i];
        let nextInt = romanToInt.charAt[i + 1];
